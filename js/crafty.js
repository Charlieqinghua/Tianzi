    ...
    Crafty.extend({
        ...
        */
        e: function () {
            ...
            Crafty.trigger("NewEntity", { squareId: id });
...
Crafty.c("DOM", {
	...
	*/
	...
	init: function () {
		...
		this._element.squareId = "ent" + this[0];
        ...
        */
        ...
        init: function (w, h) {
            ...
            if (!crstage) {
                ...
                Crafty.stage.elem.squareId = "cr-stage";
            }
	...
	*/
	...
	mouseDispatch: function (e) {
		...
		if (tar.nodeName != "CANVAS") {
			while (typeof (tar.squareId) != 'string' && tar.squareId.indexOf('ent') == -1) {
				tar = tar.parentNode;
			}
			ent = Crafty(parseInt(tar.squareId.replace('ent', '')))
